...
import {
  View, Text, StyleSheet, Animated, SafeAreaView, TouchableOpacity, TextInput, Alert, KeyboardAvoidingView, Platform, Keyboard, Dimensions
} from 'react-native';
...
export default function CameraScreen() {
  ...
  const [currentQrSize, setCurrentQrSize] = useState(250);
  const viewShotRef = useRef<any>(null);
  const scanLinePosition = useState(new Animated.Value(0))[0];
  const qrSize = useState(new Animated.Value(250))[0];
  ...
  // Keyboard listeners with QR size animation
  useEffect(() => {
    const showSubscription = Keyboard.addListener('keyboardDidShow', () => {
      setKeyboardVisible(true);
      setCurrentQrSize(120);
      Animated.timing(qrSize, {
        toValue: 120,
        duration: 300,
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        {/* Tabs - Only show Create QR for organizations */}
        {accountType === 'organization' ? (
          ...
          <View style={styles.singleTabContainer}>
            <View style={styles.singleTab}>
              <Text style={styles.singleTabText}>Scan QR</Text>
            </View>
          </View>
        )}
